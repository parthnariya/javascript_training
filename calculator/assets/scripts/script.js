...
function trigonometry(fun) {
  ...
  switch (fun) {
      case "sine":
          result = Math.sin(operationValue); //sine function 
          break;
      case "cos":
          result = Math.cos(operationValue); //cosine function
          break;
      case "tan":
          result = Math.tan(operationValue); //tangent function
          break;
      case "cot":
          result = 1 / Math.tan(operationValue); //cotangent function
          break;
      case "cosec":
          result = 1 / Math.sin(operationValue); //cosecant function
          break;
      case "sec":
          result = 1 / Math.cos(operationValue); //secant function
          break;
  }
  if (result === NaN) {
